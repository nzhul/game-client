...
public class GraphicMover : MonoBehaviour
{
    ...
    public void Move(MoveTarget moveTarget = MoveTarget.End)
    {
        var target = endXform.position;

        switch (moveTarget)
        {
            case MoveTarget.End:
                target = endXform.position;
                break;
            case MoveTarget.Start:
                target = startXform.position;
                break;
        }
