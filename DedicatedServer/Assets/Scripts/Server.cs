...
public class Server : MonoBehaviour
{
    ...
    private void OnData(int connectionId, int channelId, int recievingHostId, NetMessage msg)
    {
        switch (msg.OperationCode)
        {
            case NetOperationCode.None:
                ...
                break;
            case NetOperationCode.ConnectRequest:
                ConnectRequest(connectionId, channelId, recievingHostId, (Net_ConnectRequest)msg);
                break;
            default:
                break;
        }
    ...
    /// </summary>
    private void ConnectRequest(int connectionId, int channelId, int recievingHostId, Net_ConnectRequest msg)
    {
        Net_OnConnectRequest rmsg = new Net_OnConnectRequest();
    ...
    private void SendClient(int recievingHostId, int connectionId, Net_OnConnectRequest msg)
    {
